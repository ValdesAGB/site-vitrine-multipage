        ...
        <div className="text-center my-5">
          <div className="row justify-content-center">
            <div className="row  col-8">
              ...
              <Button
                to="/contact"
                className="btn p-4 rounded-5 bg-white border-0 col  me-2 "
              >
                NOUS CONTACTER
              </Button>
              <Link
                to="/nos-activit%C3%A9s/#conceptionTravail"
                className="btn p-3 fw-bolder rounded-5 text-white border border-white border-5 col"
              >
